...
<div class="container" style="width: 400px; margin-top: 40px; border-radius: 15px; background-color: #ffffff;">
	...
	<div style="text-align: right;">
		<a href="tela_login.php" style="margin-top: 10px;" data-toggle="tooltip" data-placement="top" title="Voltar" role="button" class="btn btn-sm btn-primary"><i class="fas fa-arrow-left"></i></a>
	</div>
